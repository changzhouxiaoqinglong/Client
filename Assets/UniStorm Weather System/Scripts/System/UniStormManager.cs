...
namespace UniStorm
{
    public class UniStormManager : MonoBehaviour
    {
        ...
        {
            WeatherType weatherType = UniStormSystem.Instance.AllWeatherTypes[4];
            UniStormSystem.Instance.ChangeWeather(weatherType);
        }
        /// <summary>
        /// 返回原天气
        /// </summary>
        private void BackWeather()
        {
            int weatherCount = NetVarDataMgr.GetInstance()._NetVarData._TaskEnvVarData.Wearth.Type;
